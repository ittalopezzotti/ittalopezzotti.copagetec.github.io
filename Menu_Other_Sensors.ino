...
***************************************************************/ 
void  Serial_Menu_Others_Sensors(){
...
/************************************************************** 
******** CASE !====>>>> H1 HUMIDITY EXTERNAL
***************************************************************/
case '|':  
    Serial.println(F(" IHS INTERNAL HUMIDITY SENSOR "));
     do
       {
         input=Serial.read();
         Humidity_H1();  
       } while (input !=113);//(quit)
          Serial.println(F(" IHS INTERNAL (H1) HUMIDITY IN OFF MODE"));
      Serial.println(F("Exit program"));
      Serial.write(12);//ASCII for a Form feed
   Menu_ppal();
break;
...
/************************************************************** 
******** CASE !====>>>> H2 HUMIDITY EXTERNAL
***************************************************************/
case '!':  
    Serial.println(F(" EHS EXTERNAL HUMIDITY SENSOR "));
     do
       {
         input=Serial.read();
         Humidity_H2(); 
       } while (input !=113);//(quit)
          Serial.println(F(" EHS EXTERNAL (H2) HUMIDITY IN OFF MODE"));
      Serial.println(F("Exit program"));
      Serial.write(12);//ASCII for a Form feed
   Menu_ppal();
break;
/************************************************************** 
******** CASE /====>>>> H1,H2 HUMIDITY SENSORS
***************************************************************/
case '/':  
    Serial.println(F(" AHS ALL HUMIDITY SENSORS "));
     do
       {
         input=Serial.read();
         All_Humidity();
       } while (input !=113);//(quit)
          Serial.println(F(" AHS ALL HUMIDITY SENSORS IN OFF MODE"));
      Serial.println(F("Exit program"));
      Serial.write(12);//ASCII for a Form feed
 Menu_ppal();
break;
...
***************************************************************/
case '+':  
    Serial.println(F(" ASF ALL SENSORS FULL "));
      do
       {
         input=Serial.read();
         All_Other_Sensors();
          ...
          Serial.println(F(" ASF ALL SENSORS FULL IN OFF MODE"));
      Serial.println(F("Exit program"));
      Serial.write(12);//ASCII for a Form feed
 Menu_ppal();
break;
...
*/
////*******END PROGRAM AND PAGE MENU OTHERS SENSORS
